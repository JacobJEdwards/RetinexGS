...
def objective(trial: optuna.Trial):
    ...
    cfg.lambda_illum_smoothness = trial.suggest_float("lambda_illum_smoothness", 0, 1.0, log=True)
    ...
    cfg.lambda_tv_loss = trial.suggest_float("lambda_tv_loss", 1.0, 5.0, log=True)
