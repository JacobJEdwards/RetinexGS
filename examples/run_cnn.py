        ...
        for step in pbar:
            ...
            with (torch.amp.autocast(device_type="cuda", enabled=True)):
                ...
                if not cfg.allow_chromatic_illumination:
                    ...
                    illumination_map = torch.minimum(illumination_map, max_rgb_channel + 1e-6)
                else:
                    illumination_map = torch.minimum(illumination_map, input_image_for_net + 1e-6)
                ...
                if cfg.loss_perceptual_color:
                    total_loss += cfg.lambda_perceptual_color * loss_perceptual_colour(reflectance_map, input_image_for_net)
